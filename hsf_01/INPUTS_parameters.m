FILENM 	=	'hsf'	;	%	
FIGCAP 	=	'hsf bedform reconstruction';	%	  (2)  Caption (CHARACTER VARIABLE)
...
SNSPF1 	=	60.0	;	%	(13) Wavelength (along-crest) of first set of plan-form sinuosities
SNMGF1 	=	8.0	;	%	(14) Amplitude (measured in plan-form) of first set of sinuosities
SNFZF1 	=	0.0	;	%	(15) Phase of first set of sinuosities
SNVLF1 	=	0.3	;	%	(16) Migration speed (along-crest) of first set of sinuosities 
...
TRENDF 	=	0	;	%	90 (21) Migration direction of bedform
...
SNSPS1 	=	60.0	;	%	(36) Wavelength (along-crest) of first set of plan-form sinuosities
SNMGS1 	=	8.0	;	%	(37) Amplitude (measured in plan-form) of first set of sinuosities
SNFZS1 	=	180.0	;	%	(38) Phase of first set of sinuosities
SNVLS1 	=	0.3	;	%	(39) Migration speed (along-crest) of first set of sinuosities 
...
TRENDS 	=	0	;	% 	(44) Migration direction of bedform
...
TRENDT 	=	330	;	%	(67) Migration direction of bedform
VELOCT 	=	2.0	;	%	(68) Mean migration speed of bedform
VLCHGT 	=	0.0	;	%	(69) Amplitude of speed cycle
VLPRDT 	=	1.0	;	%	(70) Period of speed cycle
VLFAZT 	=	0.0	;	%	(71) Phase of speed cycle


TYPE 	=	6	;	%	(72) Type of superpositioning (INTEGER)
CHOICE 	=	0	;	%	(73) Rotation option (INTEGER
ELVMIN 	=	-0.15	;	%	(74) Elevation of interdune flats 
DEPRAT 	=	0.15	;	%	(75) Rate of deposition
...
NBEDSH 	=	100	;	%	(79) Time from t=0 to beginning of depositional episode (INTEGER)
INTXBD 	=	1	;	%	(80) Interval between drawing of crossbeds (INTEGER)
FRMNUM 	=	200	;	%	(81) Time from t=0 to end of depositional episode (INTEGER)
...
SurfGridSpace = 0.5;
EdgeGridSpace = 0.5;
sizeIncreaseRate = -0.000; % [height unit/iteration], positive increase in size; negative decrease in size
